...
FC = hiv_fc_train_12wk;
FC = FC ./ max(max(FC));
SC = hiv_sc_train_12wk; 
...
save([save_dir '/Estimated_Parameter_hiv_12wk_500_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3)) num2str(saved_date(4)) num2str(saved_date(5)) num2str(saved_date(6))],'Para_E','rrr_z_max','rrr_z', 'rrr','Para_E_step_save','save_state','lembda_step_save','A_start');
