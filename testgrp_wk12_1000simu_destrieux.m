...
load ([data_dir '/' parameter_file_name],'wk12');

Para_E = wk12.Para_E_avg;
...
save( [save_dir '/agematched_1000simulation_testGrp_resLow_hiv_12wk_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3))],'CC_check','h_output','BOLD_d');
rmpath(lib_dir);
