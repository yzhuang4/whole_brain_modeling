...
%load(fullfile(data_dir,'train_test_dataset_agematch_0625.mat')) %this set
%is used for proposal, with ltnp
...
save([save_dir '/Estimated_Parameter_hiv_500_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3)) num2str(saved_date(4)) num2str(saved_date(5)) num2str(saved_date(6))],'Para_E','rrr_z_max','rrr_z', 'rrr','Para_E_step_save','save_state','lembda_step_save','A_start');
