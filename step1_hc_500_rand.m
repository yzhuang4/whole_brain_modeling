...
p = genpath('/scratch/yzhuang4/CBIG-0.7.0-Wang2018_MFMem/stable_projects/fMRI_dynamics/Wang2018_MFMem/');
addpath(p);
...
disp(['maximum estimaation steps : ' num2str(EstimationMaxStep)])
%--------------------------------------------------------------------------
...
%now randon assign value to w and i

A_start = -1/4+(1/4+1/4)*rand(2*NumC+2,1);
A = A_start;
...
mkdir(strcat('/scratch/yzhuang4/CBIG-0.7.0-Wang2018_MFMem/stable_projects/fMRI_dynamics/Wang2018_MFMem/step1_estimation/',JOB_ID))

cluster.JobStorageLocation = strcat('/scratch/yzhuang4/CBIG-0.7.0-Wang2018_MFMem/stable_projects/fMRI_dynamics/Wang2018_MFMem/step1_estimation/',JOB_ID);
...
%	Nstate = rng;   
    ...
    funcP = @(Para_E) CBIG_MFMem_rfMRI_nsolver_eul_sto(Para_E,Prior_E,SC,y,FC_mask,Nstate,7,2,0);
    funcA = @(A) CBIG_MFMem_rfMRI_nsolver_eul_sto(A,Prior_E,SC,y,FC_mask,Nstate,7,2,1);
...
%save([save_dir '/Estimated_Parameter_hc_500_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3))],'Para_E','rrr_z_max');
save([save_dir '/Estimated_Parameter_hc_500_' num2str(saved_date(1)) num2str(saved_date(2)) num2str(saved_date(3)) num2str(saved_date(4)) num2str(saved_date(5)) num2str(saved_date(6))],'Para_E','rrr_z_max','rrr_z','rrr','Para_E_step_save','save_state','lembda_step_save','A_start');
